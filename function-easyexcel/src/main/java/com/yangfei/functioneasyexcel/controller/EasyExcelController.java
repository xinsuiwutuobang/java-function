package com.yangfei.functioneasyexcel.controller;

import com.alibaba.excel.EasyExcel;
import com.alibaba.excel.support.ExcelTypeEnum;
import com.yangfei.functioneasyexcel.api.CommonResult;
import com.yangfei.functioneasyexcel.domain.Member;
import com.yangfei.functioneasyexcel.domain.Order;
import com.yangfei.functioneasyexcel.domain.OrderData;
import com.yangfei.functioneasyexcel.domain.Product;
import com.yangfei.functioneasyexcel.strategy.CustomMergeStrategy;
import com.yangfei.functioneasyexcel.util.LocalJsonUtil;
...
public class EasyExcelController {
     ...
     */
    @SneakyThrows
    @ApiOperation(value = "导入订单列表Excel")
    ...
    public CommonResult importOrderList(@RequestPart("file") MultipartFile file) {
        List<OrderData> ret = EasyExcel.read(file.getInputStream()).head(OrderData.class)
